...
class EngineRegistry:
    def __init__(self) -> None:
        ...
        self._fairface_engine: Any = None
    ...
    def get_fairface_engine(self) -> Any:
        with self._lock:
            return self._fairface_engine
    ...
    def swap_fairface_engine(self, engine: Any) -> None:
        with self._lock:
            self._fairface_engine = engine
